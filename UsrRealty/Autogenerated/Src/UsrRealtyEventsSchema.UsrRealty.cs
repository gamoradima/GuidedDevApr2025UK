	...
	public class UsrRealtyEventsSchema : Terrasoft.Core.SourceCodeSchema
	{
		...
		protected virtual SchemaLocalizableString CreateValueIsTooBigLocalizableString() {
			SchemaLocalizableString localizableString = new SchemaLocalizableString() {
				UId = new Guid("f5dfe1dd-5c76-0b85-d945-90d6de191718"),
				Name = "ValueIsTooBig",
				CreatedInPackageId = new Guid("5bb12f92-1df1-49bc-b65f-3044496af87a"),
				CreatedInSchemaUId = new Guid("a2e1a089-192c-4b63-9fd4-fa6015fc4d9b"),
				ModifiedInSchemaUId = new Guid("a2e1a089-192c-4b63-9fd4-fa6015fc4d9b")
			};
		...
		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			...
			realUIds.Add(new Guid("a2e1a089-192c-4b63-9fd4-fa6015fc4d9b"));
		}
